      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap text-center">
            <div className="w-full px-4 md:full lg:full xl:w-full">
              <div className="mb-12 max-w-[100%] lg:mb-16">
                <Link href="/" className="mb-8 inline-block text-center">
                <h2 className="font-bold text-3xl">
                  BlockIoT
                </h2>
                </Link>
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                Ready to get started? Sign up forBlockIoT today and take the hassle out of hosting and running IoT servers.
                </p>
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            ...
            &copy; Copyright 2023 <a href="https://www.trizwit.com/" rel="nofollow noopener"><b>Trizwit</b></a> . All Rights Reserved 
            </p>
          </div>
        </div>
